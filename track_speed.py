...
def draw_boxes(img, bbox, object_id, identities=None, offset=(0, 0)):
    ...
    # Remove all of the ids that are not in the current frame
    ...
    for i, box in enumerate(bbox):
        ...
        if id in speed_dict:
            ...
            speed = ''
        UI_box(box, img, label=label + str(speed) + 'km/hr', color=color,
...
if __name__ == '__main__':
    ...
    vid_writer = cv2.VideoWriter(
        f'speed_demo_{sys.argv[1]}', cv2.VideoWriter_fourcc(
